...
load("~/AutoEncoder/Saved_Objects/EMNIST/emnist_model.RData")
autoencoder <- load_model_tf("~/AutoEncoder/Saved_Objects/EMNIST/autoencoder_model_emnist.keras")
encoder <- load_model_tf("~/AutoEncoder/Saved_Objects/EMNIST/encoder_model_emnist.keras")
...
df_train <- read.csv('/Users/alaninglis/Desktop/AutoEncoder/Saved_Objects/EMNIST/ltr_train.csv', sep = ',')
df_test <- read.csv('/Users/alaninglis/Desktop/AutoEncoder/Saved_Objects/EMNIST/ltr_test.csv', sep = ',')
